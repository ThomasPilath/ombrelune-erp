...
export const pages: PageDefinition[] = [
  ...
  { id:"gestion", title:"Gestion", description:"Gérer la trésorerie et le fichier client.", href:"/gestion", icon:"bank", group:"operations", eyebrow:"Opérations" },
...
export function getPageFromPath(pathname: string): PageDefinition {
  ...
  if (["clients", "tresorerie"].includes(slug)) return getPage("gestion");
